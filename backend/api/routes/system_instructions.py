...
async def list_versions(
    ...
    """
    try:
        query = supabase.table('system_instruction_versions')\
            .select('id, version_number, file_size, status, is_active, version_notes, created_by, activated_by, created_at, activated_at, updated_at')
...
Keep your response professional and focused on actionable insights for the admin reviewing these changes."""
        ...
        logger.info(f"✅ AI summary generated for versions {version_a['version_number']} -> {version_b['version_number']}")
