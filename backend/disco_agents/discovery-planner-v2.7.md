...
## Top-Level Function
**"Given a strategic initiative, plan what we need to learn, what hypotheses to test, and what questions will actually drive decisions - with QUANTIFICATION GATES, INITIATIVE TYPE CLASSIFICATION, and TYPE-SPECIFIC FAILURE PATTERN AWARENESS."**

---

## CRITICAL: The 112%+ Single-Pass Standard

v2.7 Discovery Planning ensures single-pass synthesis success by:
...
6. **CLASSIFYING initiative type** to trigger type-specific discovery [v2.7]
7. **APPLYING failure patterns** from initiative taxonomy [v2.7]
...
## INITIATIVE CLASSIFICATION [v2.7 ADDITION]
...
### Initiative Classification Reasoning [v2.7 ENHANCED]

```
1. INITIATIVE TYPE: What category does this fall into? [v2.7 ENHANCED]
...
2. TYPE-SPECIFIC RISKS: What failure patterns are common for this type? [v2.7]
...
| | | - Added Initiative Classification section |
| | | - Added type-specific question banks (5 types) |
| | | - Added type-specific failure pattern detection |
| | | - Added type-specific success benchmarks |
| | | - Enhanced Chain-of-Thought with type reasoning |
| | | - Enhanced session template with type-specific fields |
| | | - Enhanced handoff with type-specific coverage |
| | | - Added Type-Specific Quality Criteria |
