...
## Decision-Forcing Assessment

*Include this section when the recommendation involves AI/agentic systems or significant workflow automation. This ensures the initiative meets the Decision-Forcing Canvas standard: "What must be true before building is responsible."*
...
For every "Automated" step, specify: what triggers it, what it produces, and what human review occurs before the output is used.

### Corridors (Permissions & Constraints)
...
| Dimension | Failure Mode | Blast Radius | Reversible? | Mitigation |
|-----------|-------------|-------------|-------------|------------|
| Operational | [What breaks] | [How widely] | [Yes/No] | [How to contain] |
| Reputational | [What looks bad] | [Who sees it] | [Yes/No] | [How to contain] |
| Financial | [What costs money] | [How much] | [Yes/No] | [How to contain] |
| Regulatory | [What violates rules] | [Consequences] | [Yes/No] | [How to contain] |

### Receipts (Evidence & Traceability)

| Log Category | What to Capture | Retention | Access |
|-------------|----------------|-----------|--------|
| Inputs | [Data sources, prompts, context] | [Duration] | [Who] |
| Outputs | [Responses, actions taken] | [Duration] | [Who] |
| Decisions | [Approvals, overrides, escalations] | [Duration] | [Who] |
| Errors | [Failures, fallbacks, exceptions] | [Duration] | [Who] |
...
**Authorized to Kill:** [Named person]
**Shutdown Speed:** [Immediate / hours / days]
**Mechanism:** [How shutdown works technically]
**Post-Mortem:** [How to understand what happened after shutdown]

### Drift Detection

| Indicator | Expected Range | Drift Signal | Response |
|-----------|---------------|-------------|----------|
| [Performance metric] | [Normal range] | [What triggers concern] | [What to do] |
...
**Monday Morning:** [The single smallest responsible action that moves this forward]
**Owner:** [Real name]
**By When:** [Date]
...
## Value vs. Cost of Solving

### Annual Cost of Status Quo

| Cost Driver | Estimate | Basis |
|-------------|----------|-------|
| [Time spent on workarounds] | [X hrs/week x Y people x hourly rate] | [Discovery source] |
| [Error correction / rework] | [Estimate] | [Discovery source] |
| [Opportunity cost] | [Estimate] | [Discovery source] |
| **Total Annual Cost** | **[Sum]** | |

### Implementation Cost

| Investment | Estimate | Type |
|------------|----------|------|
| [Development effort] | [Person-weeks x rate] | One-time |
| [Infrastructure / licensing] | [Estimate] | Recurring |
| [Training / change management] | [Estimate] | One-time |
...
> **Self-check:** If break-even exceeds 18 months, flag for review. Consider whether a simpler intervention (coordinate, train, document) could achieve 80% of the value at 20% of the cost.
...
*Requirements Generator v1.4 - PRD with Technical Evaluation, Platform Guidance, Value Alignment, Cost Analysis, and Decision-Forcing Assessment*
```
...
### The Decision-Forcing Test (when AI/agentic/automation involved)
- [ ] Is Workflow Delta table included showing what changes?
- [ ] Are Corridors defined (autonomous / requires approval / forbidden)?
- [ ] Are Failure Modes structured across 4 dimensions (operational/reputational/financial/regulatory)?
- [ ] Are Receipts (logging requirements) specified?
- [ ] Is Kill Switch defined with named authority and shutdown speed?
- [ ] Is Drift Detection included with response actions?

### The Value Test
- [ ] Is Value vs. Cost of Solving section included?
- [ ] Is break-even calculated?
- [ ] If break-even > 18 months, is it flagged for review?
- [ ] Have I considered whether a simpler intervention could achieve most of the value?
...
|---------|------|---------|
| **v1.4** | **2026-02-13** | Decision-Forcing Canvas integration: Workflow Delta, Corridors, Failure Modes & Blast Radius, Receipts, Kill Switch & Escalation, Drift Detection sections for AI/agentic initiatives. "Smallest Responsible Next Step" framing. KB refs: decision-forcing-canvas.md |
| **v1.3** | **2026-02-13** | Value vs. Cost of Solving section with break-even analysis, 18-month flag, simpler-intervention check. KB refs: requirements-prioritization-heuristics.md, decision-science-frameworks.md |
