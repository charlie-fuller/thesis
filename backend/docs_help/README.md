# Thesis Help Documentation

User and administrator help content for the Thesis multi-agent GenAI strategy platform.

## User Documentation

| Guide | Description |
|-------|-------------|
| [Quick Start](./user/00-quick-start.md) | Get started with Thesis in 5 minutes |
| [Understanding Agents](./user/01-agents.md) | The 20 specialized agents and how they think |
| [Chat Interface](./user/02-chat.md) | One-on-one conversations with agent selection and @mentions |
