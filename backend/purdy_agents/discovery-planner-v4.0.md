...
**v3.0 optimized for focused discovery** - One question, max 5 sessions, clear done criteria.

**v4.0 clarifies the human handoff** - This agent PLANS discovery. Humans EXECUTE it. Then Coverage Tracker assesses results.
...
### 2. The Session Design (~150 words)
...
### 3. The Quantification Gate (~50 words)
...
*Discovery Plan v4.0 - Designed for human execution*
```
...
|---------|-----------|
| Core Question | 50 |
| Session Design | 150 (50 per session, max 3 in initial plan) |
| Quantification Gate | 50 |
| Watch List | 50 |
| Handoff | 50 |
| **TOTAL** | **350** |
...
| **v4.0** | **2026-01-24** | **Human Execution Clarity:** |
| | | - Explicit: this plans, humans execute |
| | | - Discovery loop diagram (Planner ↔ Coverage) |
| | | - Session agenda with time blocks |
| | | - "Watch For" section for facilitators |
| | | - Clear handoff after each session |
| | | - 350 word max |
| | | - Big 4 quality bar |
