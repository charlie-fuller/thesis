...
def backfill_original_dates(dry_run: bool = False, limit: int = None):
    ...
    for doc in documents:
        ...
        if (
            doc.get("source_platform") == "obsidian"
            and doc.get("obsidian_vault_path")
            and doc.get("obsidian_file_path")
        ):
        ...
        original_date = extract_original_date(
            filename=filename, frontmatter=frontmatter, content=content, file_mtime=file_mtime
        )
