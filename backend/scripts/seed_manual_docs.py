...
def parse_args():
    ...
    parser.add_argument("--user-id", required=True, help="UUID of the user to own the documents")
    ...
    for file_path, relative_path in files:
        ...
        try:
            ...
            supabase.storage.from_("documents").upload(
                path=storage_path, file=content, file_options={"content-type": "text/markdown"}
            )
