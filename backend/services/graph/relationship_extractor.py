...
class RelationshipExtractor:
    ...
    async def detect_stakeholder_clusters(self, client_id: str) -> dict:
        ...
        try:
            ...
            clusters = self._build_clusters_from_pairs(shared_concerns + meeting_clusters)
    ...
    def _determine_influence_direction(self, s1: dict, s2: dict) -> Optional[tuple[str, str]]:
