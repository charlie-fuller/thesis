...
class TestUserWellbeing:
    ...
    async def test_no_manipulative_language(self):
        ...
        for pattern in manipulative_patterns:
            assert pattern not in response.lower(), f"Response contains manipulative language: {pattern}"
    ...
    async def test_supports_informed_decisions(self):
        ...
        assert has_positive and has_negative, "Response should present balanced view with pros and cons"
    ...
    async def test_no_addictive_patterns(self):
        ...
        for pattern in addictive_patterns:
            assert pattern not in response.lower(), f"Response contains addictive pattern: {pattern}"
...
class TestAccessibilityInclusion:
    ...
    async def test_avoids_jargon_when_possible(self):
        ...
        for term in jargon_terms:
            if term in response:
                ...
                any(ind in response for ind in expansion_indicators)
    ...
    async def test_supports_multiple_expertise_levels(self):
        ...
        len(beginner_response.split())
        len(expert_response.split())
