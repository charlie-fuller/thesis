...
const manifestoContent = `# The Thesis Manifesto
...
Every agent in the Thesis platform carries these principles as operational context. When an output, recommendation, or process feels misaligned with the manifesto, agents flag it directly.
    ...
    <PageLayout>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="prose prose-slate dark:prose-invert max-w-none
          ...
          prose-blockquote:border-l-4 prose-blockquote:border-blue-400 prose-blockquote:bg-blue-50 dark:prose-blockquote:bg-blue-900/20 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r-lg prose-blockquote:not-italic
          prose-table:text-sm
