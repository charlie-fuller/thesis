...
interface ProjectDocumentBrowserProps {
  projectId: string
  projectTitle: string
  isOpen: boolean
  onClose: () => void
...
export default function ProjectDocumentBrowser({
  projectId,
  projectTitle,
  isOpen,
  onClose,
  onLinked
}: ProjectDocumentBrowserProps) {
  // Search mode state
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-700">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Link existing KB documents to &quot;{projectTitle}&quot;
            </p>
          </div>
          <button
            onClick={handleClose}
