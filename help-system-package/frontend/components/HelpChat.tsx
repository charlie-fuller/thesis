    ...
    >
      ...
      <div className="p-4 border-b border-default flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-base" style={{ color: 'var(--color-text-primary)' }}>SuperAssistant Assistant</h3>
        </div>
        ...
        {!currentConversation || currentConversation.messages.length === 0 ? (
          <div className="text-center py-8">
            ...
            <div className="text-sm mb-4" style={{ color: 'var(--color-text-secondary)' }}>
              Ask me anything about SuperAssistant!
            </div>
            <div className="space-y-2 text-sm">
              <button
                onClick={() => setInput('How do I onboard a new client?')}
                className="block w-full text-left p-3 bg-subtle hover:bg-hover rounded-lg transition-colors"
                style={{ color: 'var(--color-text-primary)' }}
              >
                How do I onboard a new client?
              </button>
              <button
                onClick={() => setInput('What is TRIPS scoring?')}
                className="block w-full text-left p-3 bg-subtle hover:bg-hover rounded-lg transition-colors"
                style={{ color: 'var(--color-text-primary)' }}
              >
                What is TRIPS scoring?
              </button>
              <button
                onClick={() => setInput('How does the Correction Loop work?')}
                className="block w-full text-left p-3 bg-subtle hover:bg-hover rounded-lg transition-colors"
                style={{ color: 'var(--color-text-primary)' }}
              >
                How does the Correction Loop work?
              </button>
            </div>
          </div>
        ) : (
